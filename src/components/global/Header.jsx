...
export const Header = ({
  ...
  const breadcrumbItems_antd = breadcrumbItems.map((item) => ({
    title: item.isActive ? (
      <Text style={{ color: 'white', fontSize: '12px' }}>{item.label}</Text>
    ) : (
      <a href={item.href} style={{ color: 'white', fontSize: '12px' }}>
        {item.label}
      </a>
    )
  }));
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <Space size={16}>
            ...
            <Button 
              type="text" 
              icon={<BellOutlined style={{ color: '#003399', fontSize: '20px' }} />}
              size="small"
              style={{ 
                width: '32px', 
                height: '32px',
            ...
            >
              <Space style={{ cursor: 'pointer' }}>
                ...
                <DownOutlined style={{ color: '#003399', fontSize: '12px' }} />
              </Space>
            </Dropdown>
          </Space>
        </div>
